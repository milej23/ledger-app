...
// MainActivity parses/categorizes it the next time the app is opened.
//
// Uses a plain translucent full-screen Activity (Theme.AppCompat.Translucent.NoTitleBar)
